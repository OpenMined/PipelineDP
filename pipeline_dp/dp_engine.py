...
class DPEngine:
    ...
    def _check_budget_accountant_compatibility(
            ...
            metrics: Sequence[pipeline_dp.Metric]) -> None:
        ...
        if not is_public_partition:
            raise NotImplementedError("Private partition selection does not "
                                      "support PLD budget accounting")
        supported_metrics = [
