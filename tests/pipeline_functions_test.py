...
class LocalBackendTest(parameterized.TestCase):
    ...
    def test_local_filter_by_key(self, sharding_factor):
        ...
        keys_to_keep = [7, 9]
        result = composite_funcs.filter_by_key_with_sharding(self.backend, col, keys_to_keep, sharding_factor, "filter_by_key")
        self.assertEqual(sorted(list(result)), [(7, 1),(7, 4), (7, 5), (9, 10)])
