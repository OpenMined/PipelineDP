...
class ParameterTuning(parameterized.TestCase):
  def test_to_bin_lower(self):
    to_bin_lower = histograms._to_bin_lower
  ...
  def test_compute_frequency_histogram(self, input, expected):
    ...
    histogram = histograms._compute_frequency_histogram(
  ...
  def test_list_to_contribution_histograms(self):
    histogram1 = histograms.Histogram("CrossPartitionHistogram", None)
    histogram2 = histograms.Histogram("PerPartitionHistogram", None)
    histograms = histograms._list_to_contribution_histograms(
  ...
  def test_compute_cross_partition_histogram(self, input, expected):
    histogram = histograms._compute_cross_partition_histogram(
  ...
  def test_compute_per_partition_histogram(self, input, expected):
    histogram = histograms._compute_per_partition_histogram(
        input, pipeline_dp.LocalBackend())
  ...
  def test_compute_contribution_histograms(self, input,
    ...
    histograms = histograms.compute_contribution_histograms(
  ...
  def test_quantile_contributions(self, bins, q, expected_quantiles):
    histogram = histograms.Histogram("name", bins)
